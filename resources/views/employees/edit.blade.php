...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('employees.employee.update', $employee->empID) }}" id="edit_employee_form" name="edit_employee_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
